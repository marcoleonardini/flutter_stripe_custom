...
const _appInfo =
    AppInfo(name: 'flutter_stripe', version: '0.0.0', url: 'https://github.com/fluttercommunity/flutter_stripe/');
...
class MethodChannelStripe extends StripePlatform {
  ...
  Future<PaymentMethod> createPaymentMethod(
    ...
    return ResultParser<PaymentMethod>(parseJson: (json) => PaymentMethod.fromJson(json))
  ...
  Future<PaymentIntent> confirmPayment(
    ...
    final result = await _methodChannel.invokeMapMethod<String, dynamic>('confirmPayment', {
      'paymentIntentClientSecret': paymentIntentClientSecret,
      'params': params?.toJson(),
      'options': options?.toJson() ?? {},
    });

    return ResultParser<PaymentIntent>(parseJson: (json) => PaymentIntent.fromJson(json))
  ...
  Future<SetupIntent> confirmSetupIntent(
    ...
    final result = await _methodChannel.invokeMapMethod<String, dynamic>('confirmSetupIntent', {
  ...
  Future<PaymentIntent> handleNextAction(String paymentIntentClientSecret, {String? returnURL}) async {
    final result = await _methodChannel.invokeMapMethod<String, dynamic>('handleNextAction', {
      'paymentIntentClientSecret': paymentIntentClientSecret,
  ...
  Future<bool> isApplePaySupported() async {
    ...
    final isSupported = await _methodChannel.invokeMethod('isApplePaySupported');
  ...
  Future<void> presentApplePay(
    ...
    _methodChannel.setMethodCallHandler((call) async {
      if (call.method == 'onDidSetShippingContact') {
        final contact = ApplePayShippingContact.fromJson(call.arguments['shippingContact']);
        _methodChannel.invokeMethod('updateApplePaySummaryItems', <String, dynamic>{
          'summaryItems': paramsJson['cartItems'],
        });
        onDidSetShippingContact?.call(contact);
      } else if (call.method == 'onDidSetShippingMethod') {
        final method = ApplePayShippingMethod.fromJson(call.arguments['shippingMethod']);
        _methodChannel.invokeMethod('updateApplePaySummaryItems', <String, dynamic>{
          'summaryItems': paramsJson['cartItems'],
        });
  ...
  Future<void> updateApplePaySummaryItems({
    ...
    await _methodChannel.invokeMapMethod<String, dynamic>('updateApplePaySummaryItems', {
  ...
  Future<PaymentIntent> retrievePaymentIntent(String clientSecret) async {
    final result = await _methodChannel.invokeMapMethod<String, dynamic>('retrievePaymentIntent', {
      'clientSecret': clientSecret,
    });
  ...
  Future<void> confirmPaymentSheetPayment() async {
    final result = await _methodChannel.invokeMethod<dynamic>('confirmPaymentSheetPayment');
  ...
  Future<TokenData> createToken(CreateTokenParams params) async {
    ...
    final result = await _methodChannel.invokeMapMethod<String, dynamic>('createToken', {'params': invokeParams});

    return ResultParser<TokenData>(parseJson: (json) => TokenData.fromJson(json))
      ...
      if (result.isEmpty || result['paymentOption'] != null) {
        ...
        if (result['error'] != null) {
          ...
          throw StripeError<PaymentSheetError>(
            message: 'Unknown result this is likely a problem in the plugin $result',
  ...
  Future<PaymentMethod> createGooglePayPaymentMethod(CreateGooglePayPaymentParams params) async {
    final result = await _methodChannel.invokeMapMethod<String, dynamic>('createGooglePayPaymentMethod', {
      'params': params.toJson(),
    });
  ...
  Future<void> initGooglePay(GooglePayInitParams params) async {
    return await _methodChannel.invokeMethod('initGooglePay', {'params': params.toJson()});
  }

  @override
  Future<void> presentGooglePay(PresentGooglePayParams params) async {
    final result =
        await _methodChannel.invokeMapMethod<String, dynamic>('presentGooglePay', {'params': params.toJson()});
  ...
  Future<bool> googlePayIsSupported(IsGooglePaySupportedParams params) async {
    ...
    final isSupported = await _methodChannel.invokeMethod('isGooglePaySupported', {'params': params.toJson()});
  ...
  Future<TokenData> createApplePayToken(Map<String, dynamic> payment) async {
    final result = await _methodChannel.invokeMapMethod<String, dynamic>('createApplePayToken', {'payment': payment});
  ...
  Future<PaymentIntent> collectBankAccount({
    ...
    final result = await _methodChannel.invokeMapMethod<String, dynamic>('collectBankAccount', {
  ...
  Future<PaymentIntent> verifyPaymentIntentWithMicrodeposits({
    ...
    final result = await _methodChannel.invokeMapMethod<String, dynamic>('verifyMicrodeposits', {
      'isPaymentIntent': isPaymentIntent,
      'params': params.toJson(),
      'clientSecret': clientSecret,
    });
  ...
  @override
  Future<FinancialConnectionTokenResult> collectBankAccountToken({required String clientSecret}) async {
    final result = await _methodChannel.invokeMapMethod<String, dynamic>('collectBankAccountToken', {
      'clientSecret': clientSecret,
    });
  ...
  @override
  Future<FinancialConnectionSessionResult> collectFinancialConnectionsAccounts({required String clientSecret}) async {
    final result = await _methodChannel.invokeMapMethod<String, dynamic>('collectFinancialConnectionsAccounts', {
      'clientSecret': clientSecret,
    });
