...
class Stripe {
  ...
  Future<PaymentMethod> createPaymentMethod({
    ...
    await _awaitForSettings();
    try {
      final paymentMethod = await _platform.createPaymentMethod(params, options);
  ...
  Future<void> initPaymentSheet({
    ...
    assert(!(paymentSheetParameters.applePay != null && instance._merchantIdentifier == null),
  ...
  Future<FinancialConnectionSessionResult> collectFinancialConnectionsAccounts({required String clientSecret}) async {
    try {
      return _platform.collectFinancialConnectionsAccounts(clientSecret: clientSecret);
    } on StripeError {
      rethrow;
    }
  }
